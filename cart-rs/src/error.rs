...
use crate::cart::versions::CartVersion;

/// What section of cart an error is relevant too
#[derive(Debug, strum::Display)]
pub enum Section {
    /// The header section
    Header,
    /// The Optional header section
    OptionalHeader,
    /// They encoded data within a cart file
    Body,
    /// A block of data within a version 2 cart file
    Block,
    /// The data after a block in a version 2 cart file
    Trailer,
    /// The footer at the end of a cart file
    Footer,
}
