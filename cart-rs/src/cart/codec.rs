...
use super::versions::{CartOptions, CartVersion};
...
pub(crate) fn new_encoder(
    ...
    match version {
        #[cfg(feature = "v1")]
        CartVersion::V1 => Ok(Box::new(crate::cart::versions::v1::V1Encoder::new(
            key, options.v1,
        )?)),
        #[cfg(feature = "v2")]
        CartVersion::V2 => Ok(Box::new(crate::cart::versions::v2::V2Encoder::new(
            key, options.v2,
        )?)),
...
pub(crate) fn new_decoder(header: &Header) -> Result<Box<dyn Decode>, Error> {
    match header.version {
        #[cfg(feature = "v1")]
        CartVersion::V1 => Ok(Box::new(crate::cart::versions::v1::V1Decoder::new(header))),
        #[cfg(feature = "v2")]
        CartVersion::V2 => Ok(Box::new(crate::cart::versions::v2::V2Decoder::new(header)?)),
        // only reachable when a version was compiled out
        #[allow(unreachable_patterns)]
        disabled => Err(Error::VersionDisabled(disabled)),
    }
